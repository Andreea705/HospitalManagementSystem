...
public class AppointmentsDataInitializer implements CommandLineRunner {
    ...
    private void initializeSampleData() {
        Appointments[] sampleAppointments = {
                ...
                new Appointments("APP_1716301234572", "PATIENT_5", "DEPT_1", "2024-01-19", "ACTIVE"),
                new Appointments("APP_1716301234573", "PATIENT_6", "DEPT_3", "2024-01-19", "COMPLETED"),
                new Appointments("APP_1716301234574", "PATIENT_7", "DEPT_1", "2024-01-19", "COMPLETED"),
                new Appointments("APP_1716301234575", "PATIENT_8", "DEPT_1", "2024-01-19", "COMPLETED"),
                new Appointments("APP_1716301234576", "PATIENT_9", "DEPT_1", "2024-01-19", "COMPLETED"),
                new Appointments("APP_1716301234577", "PATIENT_10", "DEPT_1", "2024-01-19", "COMPLETED")
        };
